      ...
      <div className="col-md-6 m-auto">
        ...
        <form onSubmit={this.onSubmitSignup}>
          <div className="form-group">
            ...
            <input type="username" name="username" className="form-control" id="username" aria-describedby="username" placeholder="No space, not blank, < 10 characters"  maxLength="10" value={this.state.username} onChange={this.onChange} />
          </div>
          <div className="form-group">
            <div className="row">
            ...
            <input type="name" name="name" className="form-control" id="name" aria-describedby="name" placeholder="Not blank, < 30 characters" value={this.state.name} onChange={this.onChange} />
          </div>
          <div className="form-group">
            <div className="row">
            ...
            <input type="password" name="password" className="form-control" id="password" placeholder="No space, not blank" value={this.state.password} onChange={this.onChange} />
          </div>
          <div className="form-group">
            <label htmlFor="confirmpassword">Re-enter your Password</label>
            <input type="password" name="password2" className="form-control" id="confirmpassword" placeholder="Must match with the password above" value={this.state.password2} onChange={this.onChange} />
